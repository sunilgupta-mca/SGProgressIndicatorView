...
class ProgressIndicatorView {
     ...
     */
    static func addLoadingView(sourceView: UIView, isTabBarView: Bool, alpha: CGFloat = 0.5) {
    ...
    /*!
     ...
     @return not return any value.
     */
    static func addLoadingView(sourceView: UIView, withMessage messageString: String?, isTabBarView: Bool, yAxisValue:CGFloat = 0, alpha: CGFloat = 0.5) {
        //Check if loader view is already added into sourceView and return if already added
        guard sourceView.viewWithTag(LoaderViewTags.loaderViewTag.rawValue)  == nil else { return }
        // Set minimizeHeight for iPhoneX
        let minimizeHeight = ((Int(UIScreen.main.nativeBounds.size.height)) == 2436) ? (85) : (50)
    ...
    /*!
     ...
     @return not return any value.
     */
    static func setConstraintsForLoaderView(parentView:UIView, childView:UIView, topConstraintValue:CGFloat = 0) {
    ...
    /*!
     ...
     @return not return any value.
     */
    static func setConstraintsForLoaderViewComponents(parentView:UIView, childView:UIView, width:CGFloat, height:CGFloat, centerYConstraintValue:CGFloat = 0) {
        childView.translatesAutoresizingMaskIntoConstraints = false
    ...
    /*!
     ...
     @return not return any value.
     */
    static func removeLoadingView(sourceView: UIView) {
